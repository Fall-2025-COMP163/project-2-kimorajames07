...
class Character:
    ...
    def display_stats(self):
        ...
        print(f"📌 {self.name} | Health: {self.health} | STR: {self.strength} | MAG: {self.magic}")
...
class Warrior(Player):
    ...
    def attack(self, target):
        ...
        print(f"{self.name} performs a mighty Warrior attack for {damage} damage!")
        target.take_damage(damage)
...
class Mage(Player):
    ...
    def fireball(self, target):
        ...
        print(f"🔥 {self.name} casts FIREBALL for {damage} burning damage!")
        target.take_damage(damage)
...
class Rogue(Player):
    ...
    def attack(self, target):
        ...
        import random
        damage = self.strength
        if random.randint(1, 10) <= 3:  # 30% crit
            damage *= 2
            print(f"🎯 CRITICAL HIT! {self.name} hits for {damage} damage!")
        else:
    ...
    def sneak_attack(self, target):
        ...
        print(f"🗡️ {self.name} performs a SNEAK ATTACK for {damage} critical damage!")
        target.take_damage(damage)
